...
class fisher(Sampler):
    def initialise(self):
        ...
        self.collection = Collection(
            self.parametrization, self.likelihood, self.output)
    ...
    def run(self):
        ...
        for point in initial_sample:
            logpost, logprior, logliks, derived = self.logposterior(point)
            self.collection.add(
                point, logpost=logpost, logprior=logprior, logliks=logliks)
        ...
        param_names = list(self.parametrization.sampled_params())
